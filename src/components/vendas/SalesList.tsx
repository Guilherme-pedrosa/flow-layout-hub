...
import { Search, Eye, Edit, Trash2, MoreVertical, DollarSign, FileText, Printer, Link, Share2 } from "lucide-react";
            ...
            {filteredSales.length === 0 ? (
              ...
              filteredSales.map(sale => (
                <TableRow key={sale.id}>
                  ...
                  <TableCell>
                    {sale.status ? <SaleStatusBadge name={sale.status.name} color={sale.status.color} /> : <Badge variant="outline">-</Badge>}
                  </TableCell>
