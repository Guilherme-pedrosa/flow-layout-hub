...
import { Save, ShoppingCart, FileText, Loader2, Shield, Users, ClipboardCheck } from "lucide-react";
...
import { ClienteFormRequisitos } from "./ClienteFormRequisitos";
    ...
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="grid w-full grid-cols-8">
          ...
          <TabsTrigger value="requisitos" disabled={!clienteId}>
        ...
        <Card className="mt-4">
          <CardContent className="pt-6">
            ...
            <TabsContent value="requisitos" className="mt-0">
              {clienteId && (
                <ClienteFormRequisitos clienteId={clienteId} />
              )}
            </TabsContent>
